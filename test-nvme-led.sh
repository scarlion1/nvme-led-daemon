...
echo -e "${CYAN}   Running 20 rounds of alternating I/O...${NC}"
echo ""
sleep 2
...
for i in {1..8}; do
    echo -ne "${BLUE}  Round $i/20: Reading...${NC}\r"
    ...
    echo -ne "${BLUE}  Round $i/20: Writing...${NC}\r"
...
echo "  ✓ Mixed workload: 20 rounds alternating"
